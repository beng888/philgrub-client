...
const Veggie = () => {
  ...
  return (
    <div className="md:w-1/3 flex justify-center overflow-hidden">
      ...
      <div
        className={` h-dscreen w-dscreen bg-fourth absolute overflow-hidden delay-out-1 rounded-full transform  md:-translate-y-1/4 -z-10 md:-translate-x-1/3 md:mr-80 ${
