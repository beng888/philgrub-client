     ...
     flex items-center justify-between  w-full text-xs tracking-widest bg-gray-100 py-2 px-4"
        ...
        <>
          ...
          <p className="text-tertiary tracking-wider">
            You can edit your order until this Tuesday 11:29pm. Your order will
            be delivered to your address next Tuesday between 8am and 5pm.
          </p>
          ...
          <Elements stripe={stripePromise}>
            {checkout && <Stripe checkout={checkout} orderNotes={orderNotes} />}
          </Elements>
        </>
      )}
    </div>
